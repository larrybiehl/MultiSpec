...

{
	...
	m_staticimagename = new wxStaticText (this,
														ID3C_FileName,
														wxT("image name"),
														wxDefaultPosition,
														wxDefaultSize,
   ...
   sbSizer8->Add (bSizer791, 0, wxEXPAND);
	...
	sbSizer9 = new wxStaticBoxSizer (new wxStaticBox (this, wxID_ANY, wxT("Display")), wxVERTICAL);
	...
	m_staticText701 = new wxStaticText (sbSizer9->GetStaticBox(), wxID_ANY, wxT("Type:"), wxDefaultPosition, wxDefaultSize, 0);
   ...
   SetUpToolTip (m_staticText701, IDS_ToolTip25);
	...
	m_displaytypectrl = new wxComboBox(sbSizer9->GetStaticBox(), ID3C_DisplayType, /*wxT("3-Channel Color")*/wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
   ...
   SetUpToolTip(m_displaytypectrl, IDS_ToolTip25);
	...
	m_staticText72 = new wxStaticText(sbSizer9->GetStaticBox(), wxID_ANY, wxT("Channels:"), wxDefaultPosition, wxDefaultSize, 0);   
   SetUpToolTip(m_staticText72, IDS_ToolTip26);
	m_staticText72->Wrap(-1);
	//bSizer741->Add (m_staticText72, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT | wxALL, 5);
   bSizer741->Add (m_staticText72, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

	m_comboBox29 = new wxComboBox(sbSizer9->GetStaticBox(), ID3C_Channels, wxT("All"), wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
	m_comboBox29->Append(wxT("All"));
	m_comboBox29->Append(wxT("Subset..."));
	m_comboBox29->Enable(true);
	m_comboBox29->Hide();
	//bSizer741->Add(m_comboBox29, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT | wxALL, 5);
   bSizer741->Add(m_comboBox29, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);
	...
	m_redpromptctrl = new wxStaticText(sbSizer9->GetStaticBox(), ID3C_RedPrompt, wxT("Red:"), wxDefaultPosition, wxDefaultSize, 0);
   ...
   SetUpToolTip(m_redpromptctrl, IDS_ToolTip27);
	...
	m_redchannelctrl = new wxTextCtrl(sbSizer9->GetStaticBox(), ID3C_RedChannel, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_redchannelctrl, IDS_ToolTip27);
	...
	m_grayctrl = new wxTextCtrl(sbSizer9->GetStaticBox(), ID3C_GrayChannel, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
	m_grayctrl->SetValidator(wxTextValidator(wxFILTER_DIGITS, &m_GrayChannelString));
	m_grayctrl->Hide();

	rgsizer2->Add(m_grayctrl, 0, wxALL, 5);

	m_graypromptctrl = new wxStaticText(sbSizer9->GetStaticBox(), ID3C_GrayPrompt, wxT("Grey"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_redchaninvctrl = new wxCheckBox(sbSizer9->GetStaticBox(), IDC_RedChannelInvert, wxT("Invert"), wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_redchaninvctrl, IDS_ToolTip28);
	...
	m_greenpromptctrl = new wxStaticText(sbSizer9->GetStaticBox(), ID3C_GreenPrompt, wxT("Green:"), wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_greenpromptctrl, IDS_ToolTip29);
	...
	m_greenchannelctrl = new wxTextCtrl(sbSizer9->GetStaticBox(), ID3C_GreenChannel, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_greenchannelctrl, IDS_ToolTip29);
	...
	m_greenchaninvctrl = new wxCheckBox(sbSizer9->GetStaticBox(), IDC_GreenChannelInvert, wxT("Invert"), wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_greenchaninvctrl, IDS_ToolTip28);
	...
	m_bluepromptctrl = new wxStaticText(sbSizer9->GetStaticBox(), ID3C_BluePrompt, wxT("Blue:"), wxDefaultPosition, wxDefaultSize, 0);
   ...
   SetUpToolTip(m_bluepromptctrl, IDS_ToolTip30);
	...
	m_bluechannelctrl = new wxTextCtrl(sbSizer9->GetStaticBox(), ID3C_BlueChannel, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_bluechannelctrl, IDS_ToolTip30);
	...
	m_bluechaninvctrl = new wxCheckBox(sbSizer9->GetStaticBox(), IDC_BlueChannelInvert, wxT("Invert"), wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_bluechaninvctrl, IDS_ToolTip28);
	...
	m_legendpromptctrl = new wxStaticText(sbSizer9->GetStaticBox(), IDC_LegendFactorPrompt, wxT("Legend Factor"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_legendfactorctrl = new wxTextCtrl(sbSizer9->GetStaticBox(), IDC_LegendFactor, wxT("1"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_chandescctrl = new wxButton(sbSizer9->GetStaticBox(), ID3C_ChannelDescriptions, wxT("Channel Descriptions..."), wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_chandescctrl, IDS_ToolTip32);
	...
	m_staticText76 = new wxStaticText(sbSizer9->GetStaticBox(), wxID_ANY, wxT("Magnification:"), wxDefaultPosition, wxDefaultSize, 0);
	m_staticText76->Wrap (-1);
   SetUpToolTip(m_staticText76, IDS_ToolTip33);
	//bSizer75->Add(m_staticText76, 0, wxALIGN_CENTER, 5);
	...
	m_magnificationctrl = new wxTextCtrl(sbSizer9->GetStaticBox(), ID3C_Magnification, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_magnificationctrl, IDS_ToolTip33);
	...
	m_checkBox17 = new wxCheckBox(sbSizer9->GetStaticBox(), IDC_VectorOverlays, wxT("Include Vector Overlays"), wxDefaultPosition, wxDefaultSize, 0);
   SetUpToolTip(m_checkBox17, IDS_ToolTip31);
	...
	sbSizer10 = new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, wxT("Enhancement")), wxVERTICAL);
	...
	m_bitsofcolctrl = new wxChoice(sbSizer10->GetStaticBox(), ID3C_BitsOfColor, wxDefaultPosition, wxDefaultSize, m_bitsofcolctrlNChoices, m_bitsofcolctrlChoices, 0);
   ...
   SetUpToolTip(m_bitsofcolctrl, IDS_ToolTip34);
	...
	m_staticText68 = new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, wxT("Stretch:"), wxDefaultPosition, wxDefaultSize, 0);
	m_staticText68->Wrap(-1);   
   SetUpToolTip(m_staticText68, IDS_ToolTip35);
	gSizer2->Add(m_staticText68, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_LEFT | wxALL, 5);

   m_enhancementctrl = new wxComboBox(sbSizer10->GetStaticBox(), ID3C_Enhancement, wxT("Linear"), wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY|wxTE_PROCESS_ENTER);
   ...
   m_minmaxctrl = new wxComboBox(sbSizer10->GetStaticBox(), ID3C_MinMaxValues, wxT("Clip 0% of tails"), wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY|wxTE_PROCESS_ENTER);
   ...
   SetUpToolTip(m_staticText70, IDS_ToolTip37);
	...
	m_treatzeroctrl = new wxChoice(sbSizer10->GetStaticBox(), ID3C_TreatZeroAs, wxDefaultPosition, wxDefaultSize, m_treatzeroctrlNChoices, m_treatzeroctrlChoices, 0);
   ...
   SetUpToolTip(m_treatzeroctrl, IDS_ToolTip37);
	...
	m_staticText681 = new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, wxT("Number of display levels:"), wxDefaultPosition, wxDefaultSize, 0);
   ...
   SetUpToolTip(m_newhistctrl, IDS_ToolTip39);
	...
	//gSizer2->Add (m_newhistctrl, 0, wxALL, 5);
	gSizer2->Add (m_newhistctrl, wxSizerFlags(0).Border(wxALL, 5));

	//sbSizer10->Add (gSizer2, 1, wxEXPAND, 5);
	sbSizer10->Add (gSizer2, wxSizerFlags(1).Expand());

	//bSizer73->Add (sbSizer10, 1, wxEXPAND, 5);
   ...
   */
	...
	//bSizer67->Add (bSizer79, wxSizerFlags(1).Expand().Border(wxLEFT|wxBOTTOM|wxRIGHT,12));
   ...
   //FindWindow (ID3C_RedChannel)->SetFocus ();

	this->SetSizer(bSizer67);
	
			// Set focus and tab order
	
   SelectDialogItemText (this, ID3C_RedChannel, 0, SInt16_MAX);
...
void CMDisplaySpecsDlg::OnInitDialog(wxInitDialogEvent& event) {
...
//    mBitsOfColorIndex = Update8_16_24BitsOfColorIndex(m_BitsOfColor);
    ...
    ((wxComboBox *) FindWindow(ID3C_MinMaxValues))->SetSelection(m_MinMaxPopupCode);
...
void CMDisplaySpecsDlg::OnSelendokEnhancement(wxCommandEvent& event) {
...
void CMDisplaySpecsDlg::OnSelendokEnhancementDropDown(wxCommandEvent& event) {
    m_optionKeyFlag = FALSE;
    wxComboBox* minmaxcombo = (wxComboBox *) FindWindow(ID3C_Enhancement);
    minmaxcombo->SetSelection(-1); // set to -1 so that it can be active again when user selects it second time directly
...
//    if (wxGetMouseState().RightDown()) {
    ...
    // This is the original code for OnSelendokEnhancement
    //DDX_CBIndex(m_dialogFromPtr, ID3C_Enhancement, m_Enhancement);
    /*
    m_Enhancement = event.GetSelection();

    if (m_Enhancement == 2 && m_optionKeyFlag) {
       printf("select Gaussian... open a new dialog \n");
        SetDLogControlHilite(NULL, wxID_OK, 255);
     ...
     */
/*
    // This is the Oncloseenhancement code
    if (m_optionKeyFlag) {
       printf("Change back to Gaussian \n");
         SetComboItemText(ID3C_Enhancement,
                 2,
                 (char*) "Gaussian");
...
void CMDisplaySpecsDlg::OnSelendokMinMaxValues(wxCommandEvent& event)

{
	SInt16 channels[3];


	m_MinMaxPopupCode = ((wxComboBox*)FindWindow(ID3C_MinMaxValues))->GetSelection();
...
void CMDisplaySpecsDlg::OnSelendokMinMaxValuesDropDown(wxCommandEvent& event)
{
	...
	wxComboBox* minmaxcombo = (wxComboBox *) FindWindow(ID3C_MinMaxValues);
	//m_MinMaxPopupCode = 1;
	minmaxcombo->SetSelection(-1);    
}
...
bool CMDisplaySpecsDlg::TransferDataFromWindow() 
{
   ...
   wxComboBox* enhance = (wxComboBox *) FindWindow(ID3C_Enhancement);
	...
	wxComboBox* minmaxval = (wxComboBox *) FindWindow(ID3C_MinMaxValues);
   ...
   if(enhance->GetSelection() > -1)
	...
	m_MinMaxPopupCode = minmaxval->GetSelection();
