...
//									All rights reserved.
//
//	File:						LEnhanceStatisticsDialog.cpp : class implementation file
//	Class Definition:		LEnhanceStatisticsDialog.h
//
...

{
   ...
   SetUpToolTip (m_checkBox58, IDS_ToolTip122);
	...
	m_bcomboBox1 = new wxComboBox (sbSizer9->GetStaticBox(),
   ...
   SetUpToolTip (m_textCtrl185, IDS_ToolTip125);
	...
	m_comboBox32 = new wxComboBox (sbSizer9->GetStaticBox(),
...

{
	if (!m_updatingThresholdItemsFlag)
		...
		if (m_hardThresholdCode+1 != kUseChiChiThreshold)
			...
			wxComboBox* hardThresholdCombo =
												(wxComboBox*)FindWindow (IDC_HardThresholdCombo);
...

{
	if (!m_updatingThresholdItemsFlag)
		...
		if (m_softThresholdCode+1 != kUseChiChiThreshold)
			...
			wxComboBox* softThresholdCombo =
												(wxComboBox*)FindWindow (IDC_SoftThresholdCombo);
