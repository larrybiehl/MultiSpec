...
//									All rights reserved.
//
//	File:						LClassWeightsDialog.cpp : class implementation file
//	Class Definition:		LClassWeightsDialog.h
//
...

{
   ...
   SetUpToolTip (m_button34, IDS_ToolTip336);
	...
	m_button32 = new wxButton (this,
										wxID_CANCEL,
										wxT("Cancel"),
										wxDefaultPosition,
										wxDefaultSize,
										0);
	bSizer145->Add (m_button32, 0, wxALL, 5);
	...
	m_button33 = new wxButton (this,
										...
										wxDefaultSize,
										0);
	bSizer145->Add (m_button33, 0, wxALL, 5);
	
	bSizer142->Add (bSizer145, 1, wxALIGN_RIGHT, 5);
	*/
