...

{
   ...
   */
	...
	*/
	...
	wxStaticText* staticText63 = new wxStaticText (sbSizer8->GetStaticBox (), 
																	wxID_ANY, 
																	wxEmptyString, 
																	wxDefaultPosition, 
																	wxDefaultSize, 
																	0);
	staticText63->Wrap (-1);
	gSizer1->Add (staticText63, wxSizerFlags(0).Border (wxLEFT|wxRIGHT,5));

	wxStaticText* staticText64 = new wxStaticText (sbSizer8->GetStaticBox (), 
																	IDC_StartPrompt, 
																	wxT("Start"), 
																	wxDefaultPosition, 
																	wxSize (60,-1), 
																	0);
	staticText64->Wrap (-1);
	gSizer1->Add (staticText64, wxSizerFlags(0).Center().Border (wxLEFT|wxRIGHT,5));

	wxStaticText* staticText65 = new wxStaticText (sbSizer8->GetStaticBox (), 
																	IDC_EndPrompt, wxT("End"), 
																	wxDefaultPosition, 
																	wxSize (60,-1), 
																	0);
	staticText65->Wrap (-1);
	gSizer1->Add (staticText65, wxSizerFlags(0).Center().Border (wxLEFT|wxRIGHT,5));

	wxStaticText* staticText66 = new wxStaticText (sbSizer8->GetStaticBox (), 
																	IDC_Interval, 
																	wxT("Interval"), 
																	wxDefaultPosition, 
																	wxSize (60,-1), 
																	0);
	staticText66->Wrap (-1);
	gSizer1->Add (staticText66, wxSizerFlags(0).Center().Border (wxLEFT|wxRIGHT,5));
	...
	gSizer1->Add (m_staticText60, 
						wxSizerFlags(0).Center().Border (wxLEFT|wxTOP|wxRIGHT,5));
	...
	gSizer1->Add (m_staticText62, wxSizerFlags(0).Center().Border (wxALL,5));
	...
	gSizer1->Add (m_colstartctrl, wxSizerFlags(0).Center().Border (wxALL,5));
	...
	gSizer1->Add (m_colendctrl, wxSizerFlags(0).Center().Border (wxALL,5));
   ...
   gSizer1->Add (m_colintctrl, wxSizerFlags(0).Center().Border (wxALL,5));
