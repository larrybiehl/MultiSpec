...
//
// Revised by Larry Biehl on 04/27/2018
//
...
void CMStatisticsFrame::CreateControls2(){
   this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticText225 = new wxStaticText( this, IDC_STATIC_Class, wxT("Class:"), wxDefaultPosition, wxDefaultSize, 0 );
   ...
   SetUpToolTip(m_button56, IDS_ToolTip3);
	m_button56->SetFont( wxFont( 8, 70, 90, 90, false, wxEmptyString ) );
   ...
   SetUpToolTip(m_comboBox41, IDS_ToolTip4);
	...
	m_comboBox42 = new wxComboBox( this, IDC_HistogramStatsCombo, wxT("Combo!"), wxDefaultPosition, wxSize(170,25), 0, NULL, wxCB_READONLY);
   ...
   SetUpToolTip(m_comboBox42, IDS_ToolTip5);
	...
	m_comboBox43 = new wxComboBox( this, IDC_ListStatsCombo, wxT("Combo!"), wxDefaultPosition, wxSize(170,25), 0, NULL, wxCB_READONLY );
   ...
   SetUpToolTip(m_button65, IDS_ToolTip12);   
	...
	m_listBox4 = new wxListBox( this, IDC_ListBox, wxDefaultPosition, wxSize( -1,150 ), 0, NULL, 0 ); 
