// mimagdoc.cpp : implementation of the CMspecDoc class
//
...
{ 	 
	...
	ShowCoordinateView (displayCoordinatesFlag, TRUE);
...
void CMImageDoc::ShowCoordinateView (
				Boolean								displayCoordinatesFlag,
				Boolean								callCalculateLayoutFlag) 
{
