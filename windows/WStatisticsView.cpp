...
//
//	File:						WStatisticsView.cpp : implementation file
//
...
void CMStatisticsForm::DoDataExchange (
				CDataExchange* 					pDX)
...
CMStatisticsDoc* CMStatisticsForm::GetDocument ()
...
void CMStatisticsForm::OnAddToList (void)
...

{
	...
	switch (gProjectInfoPtr->statsWindowMode)
		...
		case 4:		// "Polygon Point List" mode
			...
			DDX_Text (m_dialogToPtr, IDC_ClassName, tempCString);
...
void CMStatisticsForm::OnInitialUpdate (void)
...
void CMStatisticsForm::OnSelendokClassList (void)
