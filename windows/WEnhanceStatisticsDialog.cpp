...
//
//	File:						WEnhanceStatisticsDialog.cpp : implementation file
//
...
void CMEnhanceStatisticsDialog::CheckColumnEnd (void)
...
void CMEnhanceStatisticsDialog::CheckColumnStart ()
...
void CMEnhanceStatisticsDialog::DoDataExchange (
				CDataExchange* 					pDX)
...
BOOL CMEnhanceStatisticsDialog::OnInitDialog ()
...

{
	...
	m_weightsSelection = UpdateDialogClassWeightsInfo ((SInt16)m_weightsSelection,
																		m_useEnhancedStatisticsFlag,
																		&m_classWeightSet,
																		FALSE);
...
void CMEnhanceStatisticsDialog::ToEntireImage (void)
...
void CMEnhanceStatisticsDialog::ToSelectedImage (void)
