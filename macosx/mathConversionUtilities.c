...
//								for the processor is not the 96 bit extended values used by the
//								68881 coprocessor.
//
...
//		#ifdef powerpc	
			...
			extended80					saneValue;
				...
				dtox80 (&doubleValue, &saneValue);
					...
					// for longDoubleValue by itself.	(4/6/94)	
...
{		
	#ifndef _MC68881_ 
		#ifdef TARGET_CPU_PPC || TARGET_CPU_X86
...
//				#endif		// !defined __XCODE__
			...
			x96tox80 ( 	extended96Ptr, 
							(extended80*)doublePtr);
