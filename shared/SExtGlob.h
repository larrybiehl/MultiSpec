...
extern DateTimeRec					gDateTimeRecord;
	...
	extern DlgHookUPP						gGetFileHookPtr;
	extern DlgHookUPP						gPutFileHookPtr;
#endif	// !TARGET_API_MAC_CARBON
...
#if TARGET_API_MAC_CARBON
			// List definition pointer storage for carbon applications.
...
//extern UserItemUPP					gDrawBitsPerDataValuePopUpPtr;
//extern UserItemUPP					gDrawBytesPerDataValuePopUpPtr;
...
extern SInt32							gTimeOffset;
			...
			// Mask to use for addresses based on whether 24 or 32 bit memory		
			// is being used.																		
extern UInt32							gAddressMask;
