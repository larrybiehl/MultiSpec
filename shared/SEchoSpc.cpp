...

{
	...
	if (echoInfoPtr->ipixels > bytesLeftForPixels/sizeof(SInt32))
		{
		...
		if (continueFlag)
			...
			tempFileNamePtr = (FileStringPtr)GetFileNamePPointer (tempFileStreamPtr);
			...
			tempFileNamePtr = (FileStringPtr)GetFilePathPPointer (tempFileStreamPtr);
