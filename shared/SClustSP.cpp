				...
				SInt16								firstLineCode) 
{
   ...
   HCMeanTypePtr closestMeanPtr; // Vector holds mean of closest	
   // 	cluster.
   ...
   //	CMeanType2							closestDistance,	// Distance from pix to closest			
   //																	//		cluster.                              	
   //											currentDistance;	// Distance from pix to current 			
   //																	//		cluster.
   RgnHandle rgnHandle;
   ...
   //	UInt32				 				criticalDistance1Squared;	// Used for standard 			
   //																				// 	deviations only.	
   UInt32 column,
           columnEnd,
           columnInterval,
