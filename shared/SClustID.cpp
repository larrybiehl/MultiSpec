...
//									All rights reserved.
//
//	File:						SClustID.cpp (clusterISODATA.c)
//
...

{
	...
	gClusterSpecsPtr->totalSumSquaresStatsPtr = 
			(HCovarianceStatisticsPtr)GetHandlePointer(
				gClusterSpecsPtr->totalSumSquaresStatsHandle, kNoLock, kNoMoveHi);
				
	totalChanStatsPtr = 
			(HChannelStatisticsPtr)GetHandlePointer(
				gClusterSpecsPtr->totalChanStatsHandle, kNoLock, kNoMoveHi);
