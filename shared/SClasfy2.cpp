...
//	SetDLogControl (dialogPtr, 14, (SInt16)gClassifySpecsPtr->testFldsFlag);
...
//	if (outputWindowFlag)				
//		gClassifySpecsPtr->outputStorageType += 1;
...

{
	...
	DrawPopUpMenuItem (dialogPtr, itemNumber, gPopUpClassifyProcedureMenu, 
							gClassificationProcedure, TRUE );
...
{	
	...
	DrawPopUpMenuItem (dialogPtr, itemNumber, 
					gPopUpAllSubsetMenu, gCorrelationMatrixClassAreaSelection, TRUE);
...

{
	...
	DrawPopUpMenuItem (dialogPtr, itemNumber, gPopUpCovarianceEstimateMenu, 
																	gCovarianceEstimate, TRUE );
...

{
	...
	DrawPopUpMenuItem (dialogPtr, itemNumber, gPopUpEchoAlgorithmMenu, 
							gEchoAlgorithmProcedure, TRUE );
...

{
	...
	DrawPopUpMenuItem (dialogPtr, itemNumber, 
			gPopUpDiskFileMenu, gOutputFormatCode, (gOutputFormatCode > 0) );
