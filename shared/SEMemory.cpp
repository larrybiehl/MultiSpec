...
//		    		DebugStr ("\pSEMemory.cpp");
//
//
//	File:						memory.c
//
//	Functions in file:	short int 			free_class_stat
...
//								short int 			malloc_common_classifier_info
//								short int			malloc_class_stat
...
}	// End of function "free_class_stat" 
...
// Coded by : Byeungwoo Jeon	Date : 10/01/91
//=====================================================================
...
// Last Revised by : Byeungwoo Jeon         Date : 09/28/91
// ==================================================================
