...
//  				DebugStr ("\pprojectUtilities.c");
//
//	File:						projectUtilities.c
//
...
//	Revised By:			Larry L. Biehl			Date: 03/29/94	
...
// Called By:	
//
//	Coded By:			C.H. Lee					Date: 07/02/96
//	Revised By:			Larry L. Biehl			Date: 09/18/97	
	...
	if (continueFlag)
		...
		for ( index=0; index<numberClasses; index++)
			...
			if (floatDataValueCode > 0)
				...
				if (numberPixels > 0)
					{
					classInfoPtr[index].floatDataValuesPtr = (HFloatPtr)MNewPointer( 
								numberPixels * numberFloatDataValueEntries * sizeof(float) );
				
					continueFlag = (classInfoPtr[index].floatDataValuesPtr != NULL);
...
// Called By:	
//
//	Coded By:			C.H. Lee					Date: 12/04/88
//	Revised By:			Larry L. Biehl			Date: 06/30/94	
											...
											
{
	...
	determinant = InvertSymmetricMatrix ( 
									tInversePtr, 
									numberFeatures, 
...
// Called By:	
//
//	Coded By:			Larry L. Biehl			Date: 05/11/90
...
// Called By:	
//
//	Coded By:			Larry L. Biehl			Date: 04/17/97
//	Revised By:			Larry L. Biehl			Date: 04/17/97	
...
//
//	Coded By:			Larry L. Biehl			Date: 01/15/89
...

{
	...
	*computeCommonCovarianceFlagPtr = FALSE;
	...
	if (minimumNumberTrainPixelsPtr != NULL)
		*minimumNumberTrainPixelsPtr = LONG_MAX;
...
// Called By:	
//
//	Coded By:			Larry L. Biehl			Date: 06/25/93
//	Revised By:			Larry L. Biehl			Date: 02/22/2000
...
//
//	Coded By:			Larry L. Biehl			Date: 01/15/89
//	Revised By:			Larry L. Biehl			Date: 06/12/98	
...

{
	...
	if (dialogPtr != NULL)
		...
		LoadDItemValue (dialogPtr, 9, (long int)1);
		LoadDItemValue (dialogPtr, 11, (long int)numberInputClasses);
		LoadDItemValue (dialogPtr, 13, (long int)1);
...
//
//	Coded By:			Larry L. Biehl			Date: 06/14/90
...

{
	...
	if (gDialogListHandle != NULL && gDialogListHandle2 != NULL)
		...
		SelectDialogItemText (dialogPtr, 9, 0, INT_MAX);
...
//
//	Coded By:			Larry L. Biehl			Date: 12/28/99
//	Revised By:			Larry L. Biehl			Date: 12/28/99
...
{	
	...
	sprintf ( (char*)&gTextString, "%3ld-", newWeight );
	stringLength = 4;
	...
	while ( LGetSelect (TRUE, &cell, classListHandle) )
		...
		NumToString ( (long int)cell.v, gTextString2 );
...
// Called By:			ClassWeightsDialog in SProjUtl.cpp
//
//	Coded By:			Larry L. Biehl			Date: 12/20/99
//	Revised By:			Larry L. Biehl			Date: 12/28/99
...
//
//	Coded By:			Larry L. Biehl			Date: 06/14/90
//	Revised By:			Larry L. Biehl			Date: 01/30/98	
...
//
//	Coded By:			Larry L. Biehl			Date: 06/14/90
//	Revised By:			Larry L. Biehl			Date: 06/18/90
...
// Called By:			ClassifyDialog   in classify.c
//
//	Coded By:			Larry L. Biehl			Date: 01/22/90
//	Revised By:			Larry L. Biehl			Date: 12/20/99
...
// Called By:			ClassWeightsDialog in SProjUtl.cpp
//
//	Coded By:			Larry L. Biehl			Date: 12/17/99
//	Revised By:			Larry L. Biehl			Date: 12/17/99
...
// Called By:			ClassWeightsDialog in SProjUtl.cpp
//
//	Coded By:			Larry L. Biehl			Date: 12/16/99
//	Revised By:			Larry L. Biehl			Date: 12/16/99
...
//
//	Coded By:			Larry L. Biehl			Date: 01/23/90
//	Revised By:			Larry L. Biehl			Date: 12/20/99	
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 01/07/94
//	Revised By:			Larry L. Biehl			Date: 01/07/94
...
//	Coded By:			Larry L. Biehl			Date: 12/20/93
//	Revised By:			Larry L. Biehl			Date: 12/20/93	
...
//
//	Coded By:			Larry L. Biehl			Date: 12/20/93
//	Revised By:			Larry L. Biehl			Date: 04/03/97	
					...
					
{
	...
	if (threshold_probability >= 1.)
		...
		#endif
		#ifndef _MC68881_
					// This was changed from 1e-18 to 1e-15 on 3/3/97 so that
...
//
//	Coded By:			Chulhee Lee				Date: ?
//	Revised By:			Larry L. Biehl			Date: 02/19/90	
...
//
//	Coded By:			Larry L. Biehl			Date: 11/16/88
	...
	if (numberPoints >= 3)
		...
		SInt16		i;
			...
			*rgnHandlePtr = NewRgn ();
			...
			pointsPtr = (POINT*)MNewPointer( numberPoints*sizeof(POINT) );
			if (pointsPtr != NULL)
...
//
//	Coded By:			Larry L. Biehl			Date: 10/31/91
//	Revised By:			Larry L. Biehl			Date: 12/30/98	
...
// Called By:			ClassifyDialog in classify.c	
//
//	Coded By:			Larry L. Biehl			Date: 02/10/90
//	Revised By:			Larry L. Biehl			Date: 11/04/90	
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 10/16/89
//	Revised By:			Larry L. Biehl			Date: 10/30/90	
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 01/12/93
//	Revised By:			Larry L. Biehl			Date: 01/12/93	
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 10/05/89
//	Revised By:			Larry L. Biehl			Date: 10/30/90	
...

{
	...
	MoveTo (popUpBox.left+leftSpace, 
											popUpBox.bottom-bottomSpace);
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 04/02/93
//	Revised By:			Larry L. Biehl			Date: 04/02/93	
...
//
//	Coded By:			Chulhee Lee				Date: ?
//	Revised By:			Larry L. Biehl			Date: 03/12/90	
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 11/19/92
//	Revised By:			Larry L. Biehl			Date: 11/19/92
...
// Called By:			FS_decision_boundary in mul.c
//
//	Coded By:			Larry L. Biehl			Date: 10/22/92
//	Revised By:			Larry L. Biehl			Date: 12/20/93	
...
//
//	Coded By:			Larry L. Biehl			Date: 08/11/97
//	Revised By:			Larry L. Biehl			Date: 01/09/98
...
// Value Returned:
//
//	Coded By:			Larry L. Biehl			Date: 07/02/96
//	Revised By:			Larry L. Biehl			Date: 07/02/96
...

{
	...
	if (classInfoPtr != NULL)
		...
		for (index=0; index<numberClasses; index++)
			...
			classInfoPtr[index].floatDataValuesPtr = NULL;
...
//
//	Coded By:			Larry L. Biehl			Date: 12/27/93
//	Revised By:			Larry L. Biehl			Date: 01/06/94
...
//
//	Coded By:			Larry L. Biehl			Date: 12/27/93
//	Revised By:			Larry L. Biehl			Date: 12/29/93
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 01/06/94
//	Revised By:			Larry L. Biehl			Date: 09/19/97	
...
//
//	Coded By:			Larry L. Biehl			Date: 09/19/97
//	Revised By:			Larry L. Biehl			Date: 12/16/99
...
//
//	Coded By:			Larry L. Biehl			Date: 12/15/88
//	Revised By:			Larry L. Biehl			Date: 03/20/99
			...
			if (definedAreaFlag)
				...
				if (maskValueRequest	!= 0)
					...
					areaDescriptionPtr->lineStart = GetFirstMaskLine (
														...
														(SInt32)areaDescriptionPtr->lineStart,
														(SInt32)areaDescriptionPtr->lineEnd,
														(SInt32)areaDescriptionPtr->lineInterval,
														(SInt32)areaDescriptionPtr->columnStart,
														(SInt32)areaDescriptionPtr->columnEnd,
														(SInt32)areaDescriptionPtr->columnInterval);
...
// Called By:			
//
//	Coded By:			Larry L. Biehl			Date: 04/08/97
//	Revised By:			Larry L. Biehl			Date: 04/08/97
...
//									All rights reserved.
//
//	Function name:		SInt32 GetMaximumPixelsPerClass
//
...
// Called By:			
//
//	Coded By:			Larry L. Biehl			Date: 09/17/97
//	Revised By:			Larry L. Biehl			Date: 01/16/98

UInt32 GetMaximumPixelsPerClass (
				UInt16*								classPtr, 
				UInt32								numberClasses, 
				SInt16								fieldTypeCode,
...
//
//	Coded By:			Larry L. Biehl			Date: 06/08/90
//	Revised By:			Larry L. Biehl			Date: 12/22/98
...
//
//	Coded By:			Larry L. Biehl			Date: 06/08/90
//	Revised By:			Larry L. Biehl			Date: 12/28/98
...
//
//	Coded By:			C.H. Lee					Date: 12/04/88
//	Revised By:			Larry L. Biehl			Date: 05/05/98	
...
//
//	Coded By:			Larry L. Biehl			Date: 12/28/93
//	Revised By:			Larry L. Biehl			Date: 01/06/94
	   ...
	   if (gProjectWindow != NULL)
         ...
         for (inIndex=0; inIndex<titleLength; inIndex++)
         	...
         	if (titleBufferPtr[inIndex] != ' ')
         		{
         		titleStringPtr[outIndex] = titleBufferPtr[inIndex];
         		outIndex++;
...
// Called By:			
//
//	Coded By:			Larry L. Biehl			Date: 04/08/98
//	Revised By:			Larry L. Biehl			Date: 04/17/2001
...
//		boundingRectPtr->right = (*rgnHandle)->rgnBBox.right;
		...
		if (returnValue == SIMPLEREGION ||
				returnValue == COMPLEXREGION)
			{  								
...

{
	...
	bytesNeeded = (long int)2 * numberClasses * sizeof(float);
...
//
//	Coded By:			Larry L. Biehl			Date: 12/26/96
//	Revised By:			Larry L. Biehl			Date: 11/08/99	
...
//
//	Coded By:			Larry L. Biehl			Date: 11/09/89
...
//
//	Coded By:			Larry L. Biehl			Date: 04/25/90
//	Revised By:			Larry L. Biehl			Date: 02/119/2000
		...
		if ( fieldIdentPtr->fieldType & fieldTypeCode)
			...
			if (continueFlag)
				...
				if (fieldIdentPtr->pointType == kRectangleType)
					...
					if ( !includeClusterFieldsFlag || !fieldIdentPtr->statsUpToDate)
...
//
//	Coded By:			Larry L. Biehl			Date: 02/13/91
...
//							ListProjectFieldsUsed in projectUtilities.c
//
//	Coded By:			Larry L. Biehl			Date: 04/10/91
//	Revised By:			Larry L. Biehl			Date: 02/09/94	
...
//
//	Coded By:			Larry L. Biehl			Date: 04/08/91
//	Revised By:			Larry L. Biehl			Date: 04/08/97	
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 01/26/94
...
{ 
	...
	if (gProjectInfoPtr->classNamesPtr[classStorage].listMessageFlag)
		...
		continueFlag = GetSpecifiedStringNumber ( 
								strListID, stringIndex, (Str255*)gTextString2, continueFlag);
		...
		if (continueFlag)
			...
			else		// stringIndex == IDS_Project69
				sprintf( (char*)&gTextString,
								(char*)&stringPtr2[1]);
...
//
//	Coded By:			Larry L. Biehl			Date: 06/14/90
//	Revised By:			Larry L. Biehl			Date: 01/04/92
...
//
//	Coded By:			Larry L. Biehl			Date: 01/17/89
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 01/16/89
//	Revised By:			Larry L. Biehl			Date: 05/17/90	
...
// Called By:			ClassPairWeightsDialog in separability.c
//
//	Coded By:			Larry L. Biehl			Date: 06/19/90
//	Revised By:			Larry L. Biehl			Date: 01/04/92
...

{
	...
	for (set=1; set<=numberWeightGroups; set++)
		...
		for (classIndex=1; classIndex<=numberOfClassesInGroup; classIndex++)
			...
			weightsListIndex++;
			NumToString ( 
						(long int)weightsListPtr[weightsListIndex], gTextString2 );
			stringLength += gTextString2[0] + 1;
...
// Called By:	
//
//	Coded By:			Larry L. Biehl			Date: 04/24/90
//	Revised By:			Larry L. Biehl			Date: 06/14/90	
...
//
//	Coded By:			Larry L. Biehl			Date: 07/26/90
//	Revised By:			Larry L. Biehl			Date: 01/04/92
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date: 03/06/91
//	Revised By:			Larry L. Biehl			Date: 09/23/97	
...
// Called By:			SymbolsDialog   in projectUtilities.c
//
//	Coded By:			Larry L. Biehl			Date: 07/25/90
			...
			if (itemHit > 2)
				...
				switch (itemHit)
					...
					case 8:
						...
						SelectDialogItemText (dialogPtr, 8, 0, INT_MAX);
...
// Called By:
//
//	Coded By:			Larry L. Biehl			Date:  1/15/89
//	Revised By:			Larry L. Biehl			Date:  7/29/97	
...
//	InvalRect (popUpProjectChangesBoxPtr);
...
//
//	Coded By:			Larry L. Biehl			Date: 11/28/89
//	Revised By:			Larry L. Biehl			Date: 05/14/98
...
//
//	Coded By:			Larry L. Biehl			Date: 12/14/88
//	Revised By:			Larry L. Biehl			Date: 11/16/99
...
{  
	if (classInfoPtr != NULL)
		...
		for ( index=0; index<numberClasses; index++)
			CheckAndDisposePtr ( classInfoPtr[index].floatDataValuesPtr );
...
// Called By:			CloseProjectStructure in project.c
//
//	Coded By:			Larry L. Biehl			Date: 11/02/92
//	Revised By:			Larry L. Biehl			Date: 11/16/99
...
// Called By:			CloseProjectStructure in project.c
//
//	Coded By:			Larry L. Biehl			Date: 10/25/89
//	Revised By:			Larry L. Biehl			Date: 11/16/99
...
//
//	Coded By:			Larry L. Biehl			Date: 04/09/90
//	Revised By:			Larry L. Biehl			Date: 11/16/99
...
//
//	Coded By:			Larry L. Biehl			Date: 11/30/93
//	Revised By:			Larry L. Biehl			Date: 11/16/99
...
// Called By:	
//
//	Coded By:			Larry L. Biehl			Date: 04/18/90
//	Revised By:			Larry L. Biehl			Date: 12/09/97
...
//	histogramPopUpLoc.v = 		
//			((ControlPtr)*gProjectInfoPtr->histogramControlH)->contrlRect.top + 1;
//	histogramPopUpLoc.h = 		
//			((ControlPtr)*gProjectInfoPtr->histogramControlH)->contrlRect.left;
	...
	if (returnCode >= 1 && returnCode <= 2)
		{
		gProjectInfoPtr->histogramClassFlag = (returnCode == 1);
		gProjectInfoPtr->histogramFieldFlag = (returnCode == 2);
		
		}		// end "if (returnCode >= 1 && returnCode <= 2)"
...
// Called By:	
//
//	Coded By:			Larry L. Biehl			Date: 10/09/97
//	Revised By:			Larry L. Biehl			Date: 10/09/97
...
//	listPopUpLoc.v = 		
//			((ControlPtr)*gProjectInfoPtr->listControlH)->contrlRect.top + 1;
//	listPopUpLoc.h = 		
//			((ControlPtr)*gProjectInfoPtr->listControlH)->contrlRect.left;
...
//
//	Coded By:			Larry L. Biehl			Date: 07/25/90
//	Revised By:			Larry L. Biehl			Date: 07/22/99	
...
//
//	Coded By:			Larry L. Biehl			Date: 03/06/91
//	Revised By:			Larry L. Biehl			Date: 01/09/99	
...
//
//	Coded By:			Larry L. Biehl			Date: 12/28/93
//	Revised By:			Larry L. Biehl			Date: 11/05/99
...
//
//	Coded By:			Larry L. Biehl			Date: 12/28/93
//	Revised By:			Larry L. Biehl			Date: 03/10/94
...
// Called By:			
//
//	Coded By:			Larry L. Biehl			Date: 03/20/99
//	Revised By:			Larry L. Biehl			Date: 03/20/99
...
//							StatisticsImageControl in statisticsImage.c
//
//	Coded By:			Larry L. Biehl			Date: 07/23/97
//	Revised By:			Larry L. Biehl			Date: 01/19/2000
