...
//			MultiplyScalarTimesMatrix(tmp_v, a-2, tmp_v, numberFeatures, 1, kTriangularMatrices);
//			diag(tmp_v, tmp_m, numberFeatures, 1);
//			AddMatrices(gPtr, tmp_m, gPtr, numberFeatures, numberFeatures);
		
		AddScalarTimesDiagonalMatrixToMatrix(
							a-2,
							commonCovariancePtr, 
							looCovariancePtr, 
							looCovariancePtr,
...

{
	...
	numberDataValues = GetClassDataValues (
